...
class Deraining(nn.Module):
    ...
    def forward(self, x, kpts):
        ...
        # return out_SR, out_combine, mul_layer, mul_layer, mul_layer, mul_residual, mul_residual
        return out_SR, out_combine, add_layer, add_layer, mul_layer, add_residual, mul_residual
