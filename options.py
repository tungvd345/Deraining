...
class TrainOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--pretrained_model', default='save/Deraining/model/model_274.pt', help='save result - model to start finetune')
		...
		self.parser.add_argument('--nThreads', type=int, default=16, help='number of threads for data loading')
